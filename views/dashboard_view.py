...
def render():
    ...
    st.markdown(
        ...
        "<span style='color:#94A3B8'>→</span>"
        "<span style='background:#EFF6FF;color:#2563EB;padding:.22rem .65rem;border-radius:999px;font-weight:600'>🤖 Gemini reads &amp; classifies the received mail</span>"
        "<span style='color:#94A3B8'>→</span>"
        "<span style='background:#EFF6FF;color:#2563EB;padding:.22rem .65rem;border-radius:999px;font-weight:600'>💼 Determines whether the Job Offer as Applied vs Offer-without-application</span>"
        "<span style='color:#94A3B8'>→</span>"
        "<span style='background:#EFF6FF;color:#2563EB;padding:.22rem .65rem;border-radius:999px;font-weight:600'>📊 Updates the Job Offer in Dashboard + Suggests subsequent action on the Job Offer</span>"
        "</div>"
