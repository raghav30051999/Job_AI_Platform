...
def render():
    ...
    st.markdown(
        ...
        "<span style='color:#94A3B8'>→</span>"
        "<span style='background:#FFFFFF;border:1px solid #BFDBFE;color:#2563EB;padding:.22rem .65rem;border-radius:999px;font-weight:600'>🤖 Gemini reads &amp; classifies</span>"
        "<span style='color:#94A3B8'>→</span>"
        "<span style='background:#FFFFFF;border:1px solid #BFDBFE;color:#2563EB;padding:.22rem .65rem;border-radius:999px;font-weight:600'>💼 Applied vs Offer-without-application</span>"
        "<span style='color:#94A3B8'>→</span>"
        "<span style='background:#FFFFFF;border:1px solid #BFDBFE;color:#2563EB;padding:.22rem .65rem;border-radius:999px;font-weight:600'>📊 Dashboard + next-step advice</span>"
        "</div>"
